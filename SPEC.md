...
37. Limo Mont mini case study strip on the homepage between Why us and How we work. Named and linked (limomont.rs), owner approved (family business, no legal concerns). Qualitative only, no numbers: full modernization of a small construction business, warehouse automation, a per project view of what each job costs and earns, and an AI agent that answers pricing and service questions from their own data. Not bookkeeping: that stays with their accountant, and claiming it would overstate into a regulated area. Corrected August 15, 2026 after the owner described what the system actually does. No metric until the owner supplies a real measured one; industry averages must never be presented as this client's result.

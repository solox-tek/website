...
That means the scope is written down in a form both sides read the same way. Not a wish, an actual description: these screens, these integrations, this data flowing from here to there, done means this. If you can hand that document to two vendors and get comparable quotes, you have something priceable.
...
Whichever model you end up with, and whoever you are talking to:

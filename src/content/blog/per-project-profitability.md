---
title: "Profitable overall, blind on every individual job"
description: "Limo Mont priced by instinct, and it worked. Now the invoice, the material, and the hours meet in one place, and every job has a number."
...
We [wrote about that system](/blog/warehouse-stock-tracking-automation/) already. A tradesman takes what he needs, sends a message saying so, and the stock count drops. It was built to stop the warehouse count from drifting.
